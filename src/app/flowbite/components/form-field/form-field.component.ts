...
import { FloatingLabelType, InputPrefixType, InputSize, InputType, InputValidation } from './form-field.properties';
...
@Component({
  ...
  template: `
    <ng-container *ngIf="(_properties | async)?.floatingLabelType as floatingLabelType; else nonFloatingTemplate">
      <div [ngClass]="{
    ...
    <ng-template #nonFloatingTemplate>
      <ng-container *ngTemplateOutlet="labelTemplate"></ng-container>
      <ng-container *ngIf="(_properties | async)?.prefixType as prefixType; else inputTemplate">
