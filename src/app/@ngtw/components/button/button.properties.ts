...
export const NGTW_BUTTON_HOST_SELECTOR_CLASS_MAP: { attribute: string; classes: Record<ButtonColors, string[]> }[] = [
  ...
  },
  {
    ...
    classes: {
      ...
      light: ['text-gray-800', 'bg-transparent', 'border', 'border-gray-800', 'enabled:hover:bg-gray-100', 'dark:border-gray-100', 'dark:text-gray-100', 'dark:enabled:hover:text-gray-100'],
