...
@Component({
  selector: 'ngtw-accordion-title',
  template: `
    <button class="flex w-full items-center justify-between py-5 px-5 text-left font-medium text-gray-500 dark:text-gray-400"
            [ngClass]="{
...
export class NgtwAccordionTitleComponent {
  constructor(
    readonly accordion: NgtwAccordionComponent,
    readonly accordionPanel: NgtwAccordionPanelComponent
  ) { }
}
